...
class FeedOPML(BaseRequestHandler):
  ...
  def get_values(self):
    return {'feeds': self.get_worksheet_data()}
  
  def get_mimetype(self):
    return 'application/atom+xml'
    
  def get_worksheet_data(self):
    url = 'https://spreadsheets.google.com/feeds/list/0Ah0xU81penP1dG1RNXV2aEpqUDZvZkxvUTdOUnVpTGc/od6/public/values?alt=json'
